    ...
    return (<section id="home" className="min-h-screen flex items-center justify-center relative">
        ...
        <div className="text-center z-10 px-4">
            ...
            <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
                I'm a passinate full-stack developer who loves crafting clean, scalable web applications.
                I love building solutions that offer both exceptional perfomance and a delightful uer experience. :)
            </p>
